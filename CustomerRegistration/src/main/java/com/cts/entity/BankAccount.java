...
//	@Pattern(regexp ="[1-9]{1}[0-9]{9}", message = "MICR must be of 10 digits")
	...
	@ManyToOne
	@ApiModelProperty(value="customer uername of the customer")
	...
	public BankAccount(int i, String string, String string2, String string3, String string4, int j, int k,
